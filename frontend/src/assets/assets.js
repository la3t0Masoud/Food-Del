...
export const food_list = [
  ...
  },
  {
    ...
    options: {
      ...
      sauce: ["Tomato", "BBQ", "Alfredo  Sauce", "garlic sauce"],
      Toppings: [
        "pepperoni",
        "chicken",
        "sausage",
      ...
      Seasonings: ["oregano", "basil", "garlic", "thyme", "red pepper flakes"],
      Cooking_Method: [
        "wood‑fired oven",
        "regular oven",
        "pan pizza",
...

  {
    ...
    HaveDetails: true,
    options: {
      Filling: ["Chicken", "bacon", "sausage", "shredded lamb"],
      Bread: ["Tortilla wraps", "Rice paper", "Puff pastry"],
      sauce: ["Chili sauce", "Mustard", "Pesto"],
      Seasonings: ["Black pepper", "paprika", "cumin", "curry", "turmeric"],
    },
  },
  {
    _id: "39",
    ...
    options: {
      ...
      Protein: ["Grilled chicken", "tuna", "boiled eggs"],
      Toppings: [
        "Olives",
        "caramelized onions",
        "sun-dried tomatoes",
  ...
  },
  {
    ...
    HaveDetails: true,
    options: {
      Bread: ["Baguette", "Sourdough", "Brioche", "Ciabatta", "Bagel"],
      Main_Filling: [
        "Grilled chicken",
        "Beef",
        "roast beef",
